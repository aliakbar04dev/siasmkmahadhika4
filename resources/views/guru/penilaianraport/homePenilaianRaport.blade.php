...
@section('content')
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Penilaian Raport</li>
            </ol>
        </section>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><center>{{ $item->data_kelas['tingkatan'] }}-{{ $item->data_kelas['jurusan'] }}-{{ $item->data_kelas['nama_kelas'] }}</td>
                                        ...
                                        <td><center><a href="/guru/viewaddraport/{{$item->id}}" class="btn btn-xs btn-success" data-toggle="tooltip" title="Input Nilai Raport Siswa/Siswi" style="color:white"><i class="fa fa-plus"></i></a></center></td>
                                        @else
                                        <td><center>{{ $item->detail_raport['ulangan_harian'] }}.00</center></td>
                                        @endif
                                        ...
                                        <td></td>
                                        @else
                                        <td><center>{{ $item->detail_raport['tugas'] }}.00</center></td>
                                        @endif
                                        ...
                                        <td></td>
                                        @else
                                        <td><center>{{ $item->detail_raport['uts'] }}.00</center></td>
                                        @endif
                                        ...
                                        <td></td>
                                        @else
                                        <td><center>{{ $item->detail_raport['uas'] }}.00</center></td>
                                        @endif
                                        ...
                                        @else
                                        <td><center>
                                        <a href="/guru/prosescetakraport/{{$item->detail_raport['id']}}" target="_blank" class="btn btn-sm btn-default" data-toggle="tooltip" title="Cetak Raport" style="color: red;"><i class="fa fa-file-pdf-o"></i></a>
                                        <a href="/guru/vieweditraport/{{$item->detail_raport['id']}}" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Update Nilai Raport" style="color:white"><i class="fa fa-edit"></i></a>
                                        <a href="/guru/proseshapusraport/{{$item->detail_raport['id']}}" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Hapus Nilai Raport" style="color:white" onclick="return confirm('Anda yakin ingin menghapus data ini ?')"><i class="fa fa-trash"></i></a>
                                        </center>
                                        </td>
                                        @endif
                                </tr>
